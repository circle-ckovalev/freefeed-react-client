...
const Terms = () => (
  <div className="box">
    ...
    <div className="box-body">
      ...
      <p>
        You own all of the content and information you post on the Service, and you can control who
        gets access to it through your privacy settings.
      </p>

      <p>
        With respect to photos, graphics, audio, video and other content you make available on the
        Service, you grant the Service worldwide, royalty-free and non-exclusive license to use,
        distribute, publish, translate, reproduce, modify, adapt, publicly perform and publicly
      ...
      <p>
        ...
        or use the Service; (ii) any conduct or content of any third party on the Service; (iii) any
      ...
      <p>
        These Terms shall be governed and construed in accordance with the laws of Estonia, without
